...
// We want to know for how long the TV has been on. In other words: 
// Given a list of arrays of time intervals, write a function that
// calculates the total amount of time covered by the intervals. 
//
// For example: 
// 
// input = [(1,4), (2,3)] 
